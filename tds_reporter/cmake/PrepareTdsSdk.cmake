...
function(_tds_assign_property key value)
    ...
    elseif(key STREQUAL "tds.sdk.certType" OR key STREQUAL "TDS_SDK_CERT_TYPE")
        set_property(GLOBAL PROPERTY TDS_PROP_CERT_TYPE "${value}")
...
function(_tds_default_properties_file out project_dir)
    set(_project_properties "${project_dir}/tds-sdk.properties")
    ...
    if(_home)
        set(${out} "${_home}/.tds_reporter/tds-sdk.properties" PARENT_SCOPE)
    else()
...
if(NOT _url)
    ...
    _tds_fail("TDS_SDK_URL is required. Set it in tds-sdk.properties, TDS_SDK_URL, or -DTDS_SDK_URL.")
endif()
...
_tds_resolve(_cert_type TDS_SDK_CERT_TYPE TDS_PROP_CERT_TYPE "PEM")
...
elseif(_auth STREQUAL "cert")
    ...
    _tds_curl_config_line(_line "cert-type" "${_cert_type}")
    list(APPEND _curl_config_lines "${_line}")
