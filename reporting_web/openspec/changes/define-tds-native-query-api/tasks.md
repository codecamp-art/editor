...
- [x] 4.4 Require PingFederate OIDC group authorization before client lookup or native TDS access in QA/PROD/DR.
...
- [x] 5.1 Implement the authorized client lookup page with client ID or name search input.
...
- [x] 6.2 Add API tests for client lookup, successful detail query, invalid input, authorization, and native failure mapping.
