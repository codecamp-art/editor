...
- Define Windows Win32/x86 native adapter debug builds, manual local SDK placement, and Jenkins-only Artifactory certificate-auth TDS SDK preparation.
...
- Keep email/report generation out of scope for `reporting_web`.
